...
let corpoEmail;
console.log('fora do setInterval');
setInterval(executaProcesso, intervalo);
console.log('saiu no setInterval');
async function executaProcesso() {
    console.log('entrou na executaProcesso');
    ...
    console.log('dataUltimoRelatorio: ' + dataUltimoRelatorio);
    const dataUltimaValidClientes = new Date(params.hrUltimaValidClientes).toDateString();
    console.log('dataUltimaValidClientes: ' + dataUltimaValidClientes);
